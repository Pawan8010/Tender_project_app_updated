...
class MpScraper(EnterpriseBaseScraper):
    def __init__(self):
        super().__init__(portal_name="MP_Tenders", base_url="https://mptenders.gov.in/nicgep/app")
    ...
    async def scrape_portal(self, page: Page):
        ...
        while pages_crawled < 5:
            ...
            try:
                # Stub extraction logic for MP_Tenders
