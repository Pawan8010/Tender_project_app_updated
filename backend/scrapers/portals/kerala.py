...
class KeralaScraper(EnterpriseBaseScraper):
    def __init__(self):
        super().__init__(portal_name="Kerala_Tenders", base_url="https://etenders.kerala.gov.in/nicgep/app")
    ...
    async def scrape_portal(self, page: Page):
        ...
        while pages_crawled < 5:
            ...
            try:
                # Stub extraction logic for Kerala_Tenders
