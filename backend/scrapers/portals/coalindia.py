...
class CoalindiaScraper(EnterpriseBaseScraper):
    def __init__(self):
        super().__init__(portal_name="CoalIndia_Tenders", base_url="https://coalindiatenders.nic.in/nicgep/app")
    ...
    async def scrape_portal(self, page: Page):
        ...
        while pages_crawled < 5:
            ...
            try:
                # Stub extraction logic for CoalIndia_Tenders
