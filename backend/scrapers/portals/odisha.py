...
class OdishaScraper(EnterpriseBaseScraper):
    def __init__(self):
        super().__init__(portal_name="Odisha_Tenders", base_url="https://tendersodisha.gov.in/nicgep/app")
    ...
    async def scrape_portal(self, page: Page):
        ...
        while pages_crawled < 5:
            ...
            try:
                # Stub extraction logic for Odisha_Tenders
