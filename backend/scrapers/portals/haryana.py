...
class HaryanaScraper(EnterpriseBaseScraper):
    def __init__(self):
        super().__init__(portal_name="Haryana_Tenders", base_url="https://etenders.hry.nic.in/nicgep/app")
    ...
    async def scrape_portal(self, page: Page):
        ...
        while pages_crawled < 5:
            ...
            try:
                # Stub extraction logic for Haryana_Tenders
