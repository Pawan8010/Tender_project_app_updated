...
def settings():
    ...
    return {
        ...
        "alert_immediate_enabled": os.getenv("ALERT_IMMEDIATE_ENABLED", "true").lower() == "true",
        "alert_max_immediate_emails_per_hour": max(0, int(os.getenv("ALERT_MAX_IMMEDIATE_EMAILS_PER_HOUR", "12"))),
        ...
        "scraper_force_playwright": os.getenv("SCRAPER_FORCE_PLAYWRIGHT", "false").lower() == "true",
        "headless_mode": os.getenv("HEADLESS_MODE", "true").lower() == "true",
        "browser_pool_size": max(1, int(os.getenv("BROWSER_POOL_SIZE", "3"))),
        "enable_sample_fallback": os.getenv("ENABLE_SAMPLE_FALLBACK", "true").lower() == "true",
        ...
        "google_discovery_enabled": os.getenv("GOOGLE_DISCOVERY_ENABLED", "true").lower() == "true",
        "google_discovery_limit_per_portal": max(1, min(10, int(os.getenv("GOOGLE_DISCOVERY_LIMIT_PER_PORTAL", "3")))),
        "google_discovery_concurrency": max(1, int(os.getenv("GOOGLE_DISCOVERY_CONCURRENCY", "4"))),
        "google_discovery_before_scrape": os.getenv("GOOGLE_DISCOVERY_BEFORE_SCRAPE", "false").lower() == "true",
