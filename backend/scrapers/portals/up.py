...
class UpScraper(EnterpriseBaseScraper):
    def __init__(self):
        super().__init__(portal_name="UP_Tenders", base_url="https://etender.up.nic.in/nicgep/app")
    ...
    async def scrape_portal(self, page: Page):
        ...
        while pages_crawled < 5:
            ...
            try:
                # Stub extraction logic for UP_Tenders
